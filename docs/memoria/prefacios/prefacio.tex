...
La evaluación realizada analiza el comportamiento del agente, las optimizaciones de búsqueda, los modelos de visión y el funcionamiento integrado del sistema. Los resultados muestran que la solución permite mantener la coherencia entre el tablero físico y la representación lógica de la partida, validar los movimientos realizados sobre el tablero real y permitir la participación de un agente automático sin sustituir la interacción física del jugador.
...
The evaluation analyzes the behavior of the agent, the search optimizations, the vision models, and the integrated operation of the system. The results show that the solution can maintain coherence between the physical board and the logical representation of the game, validate the moves performed on the real board, and allow an automatic agent to participate without replacing the player's physical interaction.
...
También quiero dar las gracias a mi familia, por su apoyo constante a lo largo de estos años. Mis padres y hermano son pilares fundamentales en mi vida, que aportan la confianza y ánimo necesarios para impulsarme en los momentos más difíciles. Sois fuente de gran inspiración, todo un ejemplo a seguir. Gracias de corazón.

No me puedo olvidar de mis amigos y compañeros, que me han acompañado durante toda mi etapa universitaria, e incluso algunos desde mucho antes.
Mi paso por la ETSIIT ha sido mucho mas facil a vuestro lado. Gracias por la ayuda compartida, el apoyo y por sacarme una sonrisa siempre que nos juntábamos.

Finalmente, me gustaría agradecer a todas las personas que, de alguna manera u otra, han formado parte de esta etapa tan bonita de mi vida y me han hecho disfrutarla como nadie. Es una suerte haber tenido el privilegio de llegar hasta aquí.

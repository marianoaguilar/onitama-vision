...
\begin{center}
{\large\bfseries Development of an intelligent system for Onitama with computer vision: Automatic reconstruction of the state of a physical game and move selection using Minimax with alpha-beta pruning}\\
\end{center}
...
Finalmente, me gustaría agradecer a todas las personas que, de alguna manera u otra, han formado parte de esta etapa tan bonita de mi vida y me han visto crecer en lo académico y en lo personal. Es una suerte haber tenido el privilegio de llegar hasta aquí.

...
La aplicación de visión por computador a un tablero físico parte de una diferencia fundamental entre la escena real y la información disponible para el sistema: la cámara no recibe directamente objetos, casillas o posiciones, sino una imagen bidimensional formada por valores de intensidad o color. Esta imagen es una proyección de la escena física y, por tanto, depende del punto de vista de la cámara, de la iluminación, de la distancia al tablero y de las propiedades visuales de los componentes observados. La visión por computador estudia precisamente cómo extraer información útil a partir de este tipo de datos visuales~\cite{szeliski2022computerVision}.
...
W{\"o}lflein y Arandjelovi{\'c} plantean el problema de determinar el estado de una partida de ajedrez a partir de una imagen. Su enfoque no trata la detección de piezas como una tarea aislada, sino como parte de un proceso más amplio en el que primero se localiza el tablero, después se transforma la imagen a una cuadrícula regular y, finalmente, se interpreta la ocupación de las casillas y el tipo de pieza presente en cada una de ellas~\cite{wolflein2021chessState}. Aunque las características visuales de cada juego sean distintas, este planteamiento ilustra una idea general aplicable a tableros físicos: la geometría de la superficie de juego proporciona un marco de referencia que facilita la interpretación posterior de los componentes.

Por ello, antes de abordar la identificación de piezas o cartas, resulta necesario tratar la imagen capturada para reducir la dependencia respecto al punto de vista de la cámara. En particular, cuando el tablero se observa desde una posición oblicua, las casillas aparecen deformadas por la perspectiva y no ocupan regiones uniformes en la imagen. La corrección de esta deformación geométrica permite trabajar con una vista más regular del tablero y constituye el paso previo a la reconstrucción visual del estado observado.

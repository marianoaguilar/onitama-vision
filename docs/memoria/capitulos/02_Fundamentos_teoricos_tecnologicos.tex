...
W{\"o}lflein y Arandjelovi{\'c} plantean el problema de determinar el estado de una partida de ajedrez a partir de una imagen. Su enfoque ilustra una estrategia habitual en tableros físicos: localizar primero la superficie de juego, transformarla después a una cuadrícula regular y utilizar esa organización espacial como base para el análisis posterior de sus elementos~\cite{wolflein2021chessState}. Aunque las características visuales de cada juego sean distintas, este planteamiento muestra la importancia de separar la normalización geométrica de la interpretación visual.
...
%==============================================================================
% 2.5. Reconocimiento visual mediante detección y clasificación.
% =============================================================================
\section{Reconocimiento visual mediante detección y clasificación}
\label{sec:reconocimiento-visual-deteccion-clasificacion}
...
El aprendizaje profundo ha reforzado este enfoque al permitir que las características visuales relevantes se aprendan directamente a partir de los datos, reduciendo la dependencia de descriptores diseñados manualmente. Estos modelos procesan la imagen mediante representaciones progresivamente más abstractas, desde patrones locales como bordes o texturas hasta estructuras visuales de mayor nivel. Esta capacidad de aprender representaciones jerárquicas a partir de los datos de entrada constituye una de las bases del aprendizaje profundo moderno~\cite{lecun2015deepLearning}.
...
La principal ventaja de la clasificación es su simplicidad conceptual: el sistema recibe una imagen ya delimitada y devuelve una identidad visual. Sin embargo, esta misma simplicidad implica una limitación importante, ya que la predicción depende de la calidad del recorte. Si la imagen incluye demasiado fondo, está mal alineada o contiene varios elementos relevantes, el resultado puede volverse menos fiable. Por este motivo, en muchos sistemas visuales la clasificación se combina con etapas previas de localización o con regiones de interés definidas a partir de la estructura de la escena.


\subsection{Detección de objetos}

La detección de objetos es una tarea de reconocimiento visual orientada a identificar y localizar elementos dentro de una imagen. A diferencia de la clasificación, no se parte necesariamente de una región ya delimitada, sino de una escena que puede contener varios objetos. Por ello, la salida de un detector suele expresarse como un conjunto de predicciones, donde cada una incluye una caja delimitadora, una etiqueta de clase y un valor de confianza asociado~\cite{szeliski2022computerVision}.

Esta salida permite transformar la imagen en una descripción estructurada de la escena. Cada caja delimitadora aproxima la posición y el tamaño de un objeto, mientras que la clase asociada indica su identidad visual. De este modo, la detección no solo informa de qué elementos aparecen en la imagen, sino también de dónde se encuentran, lo que resulta especialmente útil cuando la localización forma parte de la información que se desea recuperar.

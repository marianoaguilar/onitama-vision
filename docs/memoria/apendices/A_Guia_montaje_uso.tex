...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/montaje_fisico.JPEG}
...
\begin{enumerate}
    ...
    \item Orientar el tapete de forma que, desde la perspectiva de la cámara, el lado azul quede a la izquierda y el lado rojo a la derecha.
...
Las instrucciones de instalación y ejecución se encuentran disponibles en el repositorio público del proyecto: \url{https://github.com/marianoaguilar/onitama-vision}.

\begin{enumerate}
    \item Tras la instalación, abrir la aplicación gráfica del sistema desde un terminal mediante el comando \texttt{onitama-vision}.
